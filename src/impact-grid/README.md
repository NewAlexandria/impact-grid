## Impact Grid example usage

To use render and impact grid component, set up a grid configuration and pass in a list of data items:

```
    <impact-grid
        data-config="gridConfig"
        data-grid-data="gridData"></impact-grid>
```

It is assumed that your data is a list of JSON objects. The following section explains the grid configuration options.

## Impact Grid Directive attributes
...
## Impact Grid Configuration API

####Impact Grid Config top level properties
...
####Impact Grid Column definition <a name="col-definition"></a>
Example usage:
```
...
####Impact Grid header configuration options <a name="header-definition"></a>
Example usage:
```
...
####Impact Grid row configuration options <a name="row-definition"></a>
Example usage:
```
...
####Impact Grid pagination configuration options <a name="pagination-definition"></a>
...
####Impact Grid table configuration options <a name="table-definition"></a>
Example usage:
```
