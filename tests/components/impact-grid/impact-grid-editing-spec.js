...
describe('Grid edit and save', function() {
  ...
  beforeEach(module('impact.directives.grid'));
  ...
  var HTML_TEMPLATE = '<impact-grid ' +
      'data-grid-data="gridData" data-config="gridConfig"></impact-grid>';
  ...
  it('should save using the grid api save', function() {
    ...
    element = $compile('<impact-grid data-grid-data="gridData" ' +
        'data-grid-api="gridApi" data-config="gridConfig"></impact-grid>')($scope);
