  ...
  $scope.gridConfig = {
    columns: [
      ...
      },
      {
        field: 'delete',
        css: {
          cell: ['impact-delete-cell']
        },
        template: '<a href="" class="impact-delete-row-btn" ng-disabled="!row.canEdit(row)" ng-click="row.deleteRow(row)" ng-class="{\'delete-in-progress\': row.deleteInProgress }"></a>'
      }
    ],
    header: {
      isSticky: true
