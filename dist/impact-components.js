...
angular.module('impact.components', [
  'impact.directives.grid',
  'impact.factory.dialog'
]);

// grid module
angular.module('impact.directives.grid', ['impact.directives.templates']);

// dialog module
angular.module("impact.factory.dialog", []);
...
var myModule = angular.module('impact.directives.grid');
...
impactGridModule.factory('CellModel', function(){
  /**
...
impactGridModule.factory('RowModel', ['CellModel', function (Cell) {
  /**
...
impactGridModule.directive('impactGridTd', ['$compile', function($compile) {
  return {
    restrict: 'C',
...
impactGridModule.directive('impactGridTh', ['$compile', function($compile) {
  function ImpactThController($scope) {
    this.scope_ = $scope;
  }
   ...
   * @private
   */
  ImpactThController.prototype.sortBy_ = function (thCol) {
   ...
   * @private
   */
  ImpactThController.prototype.setRowAndColSpans_ = function (element, thCol) {
    if (thCol.rowSpan) {
 ...
 * @constructor
 */
function ImpactGridController($scope, $filter, RowModel) {
  this.scope_ = $scope;
  this.filter_ = $filter;
...
ImpactGridController.$inject = ['$scope', '$filter', 'RowModel'];

/**
 * @param column
 * @private
 */
ImpactGridController.prototype.addFlattenedColumn_ = function(column) {
 ...
 * @private
 */
ImpactGridController.prototype.setFlattendedColumns_ = function (gridConfig) {
 ...
 * @returns {*}
 */
ImpactGridController.prototype.getConfig = function() {
 ...
 * @private
 */
ImpactGridController.prototype.buildTableRows_ = function (rowData, columnOrdering, rowConfig) {
 ...
 */
ImpactGridController.prototype.getAllRows = function () {
  return this.rows_;
};

ImpactGridController.prototype.getRowsForPage = function(pageNumber) {
 ...
 */
ImpactGridController.prototype.save = function() {
 ...
 */
ImpactGridController.prototype.getAppScope = function() {
 ...
 *      wrappers around the grid data.
 */
ImpactGridController.prototype.getViewPortRows = function () {
  var paginationState = this.getConfig().pagination;
 ...
 * @private
 */
ImpactGridController.prototype.sortColumnBy_ = function (event, column) {
...
impactGridModule.controller('ImpactGridController', ImpactGridController);

impactGridModule.directive('impactGrid', function () {
  return {
    restrict: 'E',
    scope: {
      config: '=',
    ...
    templateUrl: 'templates/impact-grid/impact-grid.html',
    replace: true,
